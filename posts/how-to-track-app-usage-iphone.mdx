...
- [Screen Time Realtime Control](/): This app will start a stopwatch on the Dynamic Island so you can see how much time you are spending in real-time inside an app. Inside the app you can view a breakdown of how much time you've spent on all your apps.
