...
[MoneyCoach](https://apps.apple.com/app/apple-store/id989642198?pt=118449936&ct=website&mt=8) can help you with all of the above, apart from the cooking part. You can create budgets, set up goals, read on more possibilities on how to make money online and so much more. The New Year is the perfect time to start using an app like MoneyCoach.
