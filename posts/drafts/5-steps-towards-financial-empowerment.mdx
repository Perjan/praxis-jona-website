...
Pay off debt by either paying debt that has the highest interest rate first or pay the smallest debt with the largest payment possible, until paid off. Be sure to incorporate [debt repayment](https://moneycoach-app.com/getting-started-how-to-manage-debts-with-moneycoach/) into your budget. You should always pay more than the minimum balance on credit card bills. This will help you pay off the debt sooner.
