...
- Download the new MoneyCoach Mac app via the link - [Download Now](https://apps.apple.com/de/app/moneycoach-financial-habits/id989642198?l=en)
- Open the app
...
- "I installed the new app and the subscriptions are not syncing"
    - Make sure to turn on Cloud Drive on your iCloud settings. Click [here](https://moneycoach.ai/how-to-share-your-moneycoach-premium-subscription-on-your-mac-too/) for an expanded guide on how to do that.
