...
If you select another CSV file, not the Apple Card statement, you will have to manually map the fields. For more details about this, check the CSV import guide [here.](/import-csv-files-in-moneycoach/)

We also made this helpful video tutorial. Check it out:

<YouTube url="https://www.youtube.com/watch?v=Dw_WIBMGnwE" />
