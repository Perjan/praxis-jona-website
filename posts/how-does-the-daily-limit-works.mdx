...
summary: "You will learn how the Daily Limit calculation works."
---
...
- If you want to hide transfers in the reports, you can just turn off the "Include Transfers" switch when you filter a specific report. Keep in mind that the filter works only for the reports and will not affect the summary cards in the Overview.
