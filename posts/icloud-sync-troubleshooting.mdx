...
10\. If this doesn't fix it then do try to "reset" the iCloud Sync. [Here's](https://moneycoach.ai/how-to-reset-the-icloud-sync/) a detailed guide on how to do that.

If you still need help, please send us a message at [support@moneycoach-app.com](mailto:support@moneycoach-app.com) or contact iCloud support directly at [http://www.apple.com/support/icloud](http://www.apple.com/support/icloud/)
