...
const parentCanonical = "/en/services/hair-loss-berlin-mitte";
...
export function generateMetadata({ params }: { params: { slug: string } }): Metadata {
  ...
  return buildMetadata({
    ...
    canonical: page.href,
    alternate: page.alternate ?? `/leistungen/haarausfall-berlin-mitte/${germanAestheticSlugForEnglish(sectionKey, params.slug) ?? ""}`,
    locale: "en",
  });
}
