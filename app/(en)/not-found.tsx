...
import NotFoundAgentGuide from "app/components/NotFoundAgentGuide";
  ...
  return (
    <main className="grid min-h-full place-items-center bg-white py-24 px-6 sm:py-32 lg:px-8">
      <div className="w-full max-w-2xl text-center">
        ...
        <p className="mt-6 text-base leading-7 text-primaryLighter">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          ...
          <Link href="/en/contact" className="text-sm font-semibold text-primary">
            Contact support <span aria-hidden="true">&rarr;</span>
          </Link>
        </div>
        <NotFoundAgentGuide locale="en" />
      </div>
    </main>
  );
}
