...
export default function HeroSection() {
  return (
    <div className="relative isolate overflow-hidden pt-4 sm:pt-14 bg-fixed bg-cover lg:shrink" style={{ backgroundImage: 'url("/images/clinic/clinic-new.jpeg")', position: 'relative' }}>
