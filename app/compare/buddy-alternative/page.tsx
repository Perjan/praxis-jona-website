...
const sections = [
    {
        name: 'Features',
        features: [
            { name: 'Manual Entry', tiers: { Buddy: true, MoneyCoach: true } },
            { name: 'Online Banking', tiers: { Buddy: true, MoneyCoach: false } },
            { name: 'Shared Budgets', tiers: { Buddy: true, MoneyCoach: false } },
            { name: 'Quick Entry', tiers: { Buddy: false, MoneyCoach: true } },
            { name: 'Siri Shortcuts', tiers: { Buddy: false, MoneyCoach: true } },
            { name: 'Live Activities', tiers: { Buddy: false, MoneyCoach: true } },
            { name: 'CSV Import', tiers: { Buddy: false, MoneyCoach: true } },
            { name: 'Multi-Currency Support', tiers: { Buddy: false, MoneyCoach: true } },
            { name: 'Desktop-class iPad App', tiers: { Buddy: false, MoneyCoach: true } },
            { name: 'Native Mac App', tiers: { Buddy: false, MoneyCoach: true } },
        ],
    }
]
                    ...
                    <div className="py-24 sm:py-32 lg:pb-16">
                        <div className="mx-auto max-w-7xl px-6 lg:px-8">
                            <div className="mx-auto max-w-2xl text-center">
                                <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">What is the Best Alternative to Buddy?</h1>
                                <p className="mt-6 text-lg leading-8 text-gray-300">Buddy helps you set up budgets and keep track of your expenses. While Buddy allows you to connect your bank accounts directly, it does not support CSV Import, Siri Shortcuts, Live Activities and the reports are not that expansive. It is also not available on Mac.</p>
                                <p className="mt-6 text-lg leading-8 text-gray-300">MoneyCoach is designed to not only allow users to set up budgets and track their finances, but it also supports CSV Imports, Siri Shortcuts, Live Activities and features a ton of helpful reports. It is also available on Mac.</p>
                            </div>
                            <Image
                                src={BuddyImage}
                                alt="App screenshot"
                            ...
                            <div className="my-auto lg:pr-8 lg:pt-4">
                                <div className="lg:max-w-lg">
                                    <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Powerful Cash
                                        Tracking</p>
                                    <p className="mt-6 text-lg leading-8 text-gray-600">Besides allowing you to connect to your bank accounts directly, Buddy also features manual entry. However, with MoneyCoach we have taken manual tracking to the next level.</p>
                            ...
                            <div className="my-auto content-center lg:ml-auto lg:pl-4 lg:pt-4">
                                <div className="lg:max-w-lg">
                                    <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Native Apple Product
                                        Feel</p>
                                    <p className="mt-6 text-lg leading-8 text-gray-300">Buddy looks cool and is available on iPhone, iPad and Apple Watch, but it’s not on Mac.MoneyCoach is built to look and feel like an Apple product with deep iOS and Mac integration.</p>
                                    <p className="mt-6 text-lg leading-8 text-gray-300">You can use it on your iPhone, iPad, Mac and Apple Watch and everything is synced seamlessly across your devices via iCloud. All without the need to register or log in.</p>
                                </div>
                            </div>
                            ...
                            <div className="my-auto content-center lg:pr-8 lg:pt-4">
                                <div className="lg:max-w-lg">
                                    ...
                                    <p className="mt-6 text-lg leading-8 text-gray-600">
                                        While Buddy has some cool Budget insights, that’s about it. MoneyCoach currently includes over 11 powerful intuitive reports, with more coming in the future, that will help you understand where your money goes and where you can save more.</p>
                                    <p className="mt-6 text-lg leading-8 text-gray-600">
