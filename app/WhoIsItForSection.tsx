...
export default function WhoIsItForSection(params: { title: string, description: string, features: any[] }) {
  return (
        ...
        <ul role="list" className="mx-auto mt-20 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {
            params.features.map((feature) => (
              <li key={feature.title}>
                <Image className=" w-full rounded-2xl object-cover" src={feature.image} alt="" width={400} height={400} />
