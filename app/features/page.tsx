...
export default function Features() {
    ...
    useEffect(() => {
        console.log('Client component asdas rendered');
    });
    ...
    return (
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <ul role="list" className="mx-auto mt-20 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/widgetsFeature.png" alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/attachmentsFeature.png"
                alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/appleCardFeature.png"
                alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/bulkFeature.png" alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/academyFeature.png" alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/overviewFeature.png"
                alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/navigationFeature.png"
                alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/menuFeature.png" alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/personalizeFeature.png"
                alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/sidebarFeature.png" alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/darkModeFeature.png"
                alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/keyboardFeature.png"
                alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/touchbarFeature.png"
                alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/syncFeature.png" alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/csvFeature.png" alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/notificationsFeature.png"
                alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/securityFeature.png"
                alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/backupFeature.png" alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/reportFeature.png" alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/watchFeature.png" alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/calendarFeature.png"
                alt=""/>
            ...
            <li>
              <img className="aspect-[3/2] w-full rounded-2xl object-cover" src="images/features/payeesFeature.png" alt=""/>
...
// a function that gets the text from h3, p elements, and the image src and outputs it as a json object.
function getFeatures() {
    const features = []
//find all ul elements
    const featureElements = document.querySelectorAll('ul')
    console.log(featureElements);

    // featureElements.forEach(feature => {
    //     const imgSrc = feature.querySelector('img').getAttribute('src')
    //     const title = feature.querySelector('h3').innerText
    //     const description = feature.querySelector('p').innerText

    //     features.push({ imgSrc, title, description })
    // })

    return JSON.stringify(features, null, 4)
}

// // this function is used to make sure the function is called after the dom has been loaded.
...
// waitForElementToDisplay('ul', 1000)