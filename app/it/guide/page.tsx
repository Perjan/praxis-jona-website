...
const title = 'Guide'
const description = "Scopri come usare MoneyCoach, come impostare i tuoi conti, come gestire i movimenti, come creare budget e obiettivi, come usare l'app sul tuo Apple Watch e molto altro ancora.\n\nQueste guide sono solo in Inglese. Utilizza la funzione di traduzione integrata nel browser per tradurre le guide."
