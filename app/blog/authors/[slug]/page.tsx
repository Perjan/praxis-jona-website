    ...
    <div className="bg-white py-24 md:py-32">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-5">
        <div className="max-w-2xl xl:col-span-2">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">About {author.name}</h2>
        ...
        <ul role="list" className="-mt-12 space-y-12 divide-y divide-gray-200 xl:col-span-3">
          <li key={author.name} className="flex flex-col gap-10 pt-12 sm:flex-row">
            <Image className="aspect-[4/5] w-52 flex-none rounded-2xl object-cover" src={author.image} alt="" />
            <div className="max-w-xl flex-auto">
              ...
              <ul role="list" className="mt-6 flex gap-x-6">
                <li>
                  <a href={author.twitterUrl} className="text-gray-400 hover:text-gray-500">
