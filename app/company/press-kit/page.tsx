            ...
            <div className="bg-white py-24 md:py-32">
                <div className="mx-auto grid max-w-7xl grid-cols-1 gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-5">
                    ...
                    <ul role="list" className="-mt-12 space-y-12 divide-y divide-gray-200 xl:col-span-3">
                        ...
                        <li className="flex flex-col gap-10 pt-12 sm:flex-row">
                            <Image width={imageWidth} height={imageHeight} className="aspect-[4/5] w-52 flex-none rounded-2xl object-cover" src="/images/press/techcrunch.jpg" alt="" />
                            <div className="max-w-xl flex-auto">
                                <h3 className="text-lg font-medium leading-8 tracking-tight text-gray-900">TechCrunch</h3>
                                <h2 className="text-2xl font-semibold leading-8 tracking-tight text-gray-900 pt-4">These iOS 17 apps bring interactive widgets to your iPhone Home Screen</h2>
                                <div className="mt-10 flex items-center gap-x-6">
                                    <a target="_blank" rel='noopener noreferrer nofollow' href="https://techcrunch.com/2023/09/18/these-ios-17-apps-bring-interactive-widgets-to-your-iphone-home-screen/"
                                        className="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Read
                                        More</a>
                                </div>
                            </div>
