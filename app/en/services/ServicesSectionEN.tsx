...
export default function ServicesSection() {
  ...
  const handleScrollToProduct = (id) => {
    const product = ServicesEN.find(p => p.id === id);
  ...
  const gesetzlicheLeistungen = ServicesEN.filter(service => service.type === 'gesetzliche');
  const privateLeistungen = ServicesEN.filter(service => service.type === 'private');
      ...
      <div className="py-16 sm:py-24 lg:mx-auto lg:max-w-7xl lg:px-8">
        ...
        <div>
          <div className="flex items-center justify-between px-4 sm:px-6 lg:px-0">
            <h2 className="text-4xl font-serif tracking-tight text-primary">Standard Services</h2>
          </div>
        ...
        <div className="mt-16">
          <div className="flex items-center justify-between px-4 sm:px-6 lg:px-0">
            <h2 className="text-4xl font-serif tracking-tight text-primary">Additional Services</h2>
          </div>
          <div className="relative mt-8">
            <div className="relative -mb-6 w-full pb-6">
