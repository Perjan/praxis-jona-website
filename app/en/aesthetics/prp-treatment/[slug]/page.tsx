...
const parentCanonical = "/en/aesthetics/prp-treatment";
...
export function generateMetadata({ params }: { params: { slug: string } }): Metadata {
  ...
  return buildMetadata({
    ...
    canonical: page.href,
    alternate: page.alternate ?? `/aesthetik/prp-behandlung/${germanAestheticSlugForEnglish(sectionKey, params.slug) ?? ""}`,
    locale: "en",
  });
}
