            ...
            <div className="overflow-hidden bg-white relative isolate">
                ...
                <div className="overflow-hidden px-4 lg:px-0 rounded-xl lg:rounded-2xl bg-white max-w-7xl mx-auto sm:mb-16">
                    <SectionWithColor backgroundClassName='bg-lightBeige'>
                        <p className="mt-2 text-lg leading-8 text-primaryLighter">Lipid metabolism disorders are divided into two large groups:  </p>
                        ...
                        <ul className="px-4 sm:px-8 list-disc text-base sm:text-lg leading-6 sm:leading-8 text-primaryLighter">
                            <li className="mt-2 text-lg sm:text-lg font-serif leading-8 font-semibold text-primaryLighter">Genetic, e.g. Familial Hypercholesterolemia</li>
                        </ul>
                            ...
                            <div className="col-span-1">
                                <ul className="px-4 sm:px-8 list-disc text-base sm:text-lg leading-6 sm:leading-8 text-primaryLighter">
                                    ...
                                    <ul className="px-4 sm:px-8 list-disc text-base sm:text-lg leading-6 sm:leading-8 text-primaryLighter">
                                        ...
                                        <ul className="px-4 sm:px-8 list-disc text-base sm:text-lg leading-6 sm:leading-8 text-primaryLighter">
                                            <li>Obesity</li>
                                            <li>Diabetes mMllitus Type 2</li>
                        ...
                        <p className="mt-6 text-lg leading-8 text-primaryLighter">As lipid metabolism disorders often do not cause any direct symptoms, regular medical check-ups are crucial in order to recognize and treat possible risks at an early stage.</p>
                        ...
                        <ul className="px-8 list-disc text-lg leading-8 text-primaryLighter">
                            ...
                            <p className="text-lg">This test measures total cholesterol, LDL cholesterol, HDL cholesterol and triglycerides. You should be fasting for this test.</p>
