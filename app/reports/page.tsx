                        ...
                        <div
                            ...
                            <div className="my-auto content-center lg:ml-auto lg:pl-4 lg:pt-4">
                                <div className="lg:max-w-lg">
                                    ...
                                    <p className="mt-6 text-lg leading-8 text-gray-300">The projection report offers you a valuable insight into your net worth for the current year by analyzing your spending habits. By analyzing income, expenses, and savings patterns, the report generates a forecast of net worth, providing you with a clear understanding of your financial trajectory and helping you make informed decisions to achieve your financial goals.</p>
                                </div>
                            </div>
                            <div className="flex items-start justify-end lg:order-first">
