...
export const pricingSections = {
  ...
  microneedling: {
    ...
    rows: [
      { slug: "vampirelift-medizinisches-microneedling-gesicht", label: { de: "Vampirelift + med. Microneedling Gesicht", en: "Vampire lift + medical microneedling face" }, price: { amount: 349, currency: "EUR" }, detailHref: { de: `${microneedlingHref.de}/vampirelift-medizinisches-microneedling-gesicht`, en: `${microneedlingHref.en}#vampire-lift-medical-microneedling-face` }, bookingUrls: Constants.appointmentUrlsByService.microneedlingVampirelift, packageOffer: { quantity: 3, label: threeTreatmentBadge, badge: threeTreatmentBadge, price: { amount: 999, currency: "EUR" } } },
      ...
      { slug: "microneedling-face-nctf", label: { de: "Microneedling FACE + NCTF", en: "Microneedling FACE + NCTF" }, price: { amount: 299, currency: "EUR" }, detailHref: { de: `${microneedlingHref.de}/microneedling-face-nctf`, en: `${microneedlingHref.en}#microneedling-face-nctf` }, bookingUrls: Constants.appointmentUrlsByService.microneedlingFaceNctf },
  ...
  skinbooster: {
    ...
    rows: [
      { slug: "nctf-ha-gesicht", label: { de: "NCTF HA Gesicht", en: "NCTF HA face" }, price: { amount: 249, currency: "EUR" }, detailHref: { de: `${skinboosterHref.de}/nctf-ha-gesicht`, en: `${skinboosterHref.en}#nct-145-ha` }, bookingUrls: Constants.appointmentUrlsByService.skinboosterNctfFace, packageOffer: { quantity: 3, label: threeTreatmentBadge, badge: threeTreatmentBadge, price: { amount: 669, currency: "EUR" } } },
      { slug: "nctf-ha-gesicht-hals", label: { de: "NCTF HA Gesicht + Hals", en: "NCTF HA face + neck" }, price: { amount: 299, currency: "EUR" }, detailHref: { de: `${skinboosterHref.de}/nctf-ha-gesicht-hals`, en: `${skinboosterHref.en}#nct-145-ha` }, bookingUrls: Constants.appointmentUrlsByService.skinboosterNctfFaceNeck, packageOffer: { quantity: 3, label: threeTreatmentBadge, badge: threeTreatmentBadge, price: { amount: 799, currency: "EUR" } } },
      { slug: "nctf-ha-gesicht-hals-dekollete", label: { de: "NCTF HA Gesicht + Hals + Dekolleté", en: "NCTF HA face + neck + decollete" }, price: { amount: 379, currency: "EUR" }, detailHref: { de: `${skinboosterHref.de}/nctf-ha-gesicht-hals-dekollete`, en: `${skinboosterHref.en}#nct-145-ha` }, bookingUrls: Constants.appointmentUrlsByService.skinboosterNctfFaceNeckDecollete, packageOffer: { quantity: 3, label: threeTreatmentBadge, badge: threeTreatmentBadge, price: { amount: 999, currency: "EUR" } } },
      { slug: "philart-gesicht", label: { de: "PhilArt Gesicht", en: "PhilArt face" }, price: { amount: 299, currency: "EUR" }, detailHref: { de: `${skinboosterHref.de}/philart-gesicht`, en: `${skinboosterHref.en}#polynucleotides-philart` }, bookingUrls: Constants.appointmentUrlsByService.skinboosterPhilartFace, packageOffer: { quantity: 3, label: threeTreatmentBadge, badge: threeTreatmentBadge, price: { amount: 799, currency: "EUR" } } },
      { slug: "philart-auge", label: { de: "PhilArt Auge", en: "PhilArt eye" }, price: { amount: 299, currency: "EUR" }, detailHref: { de: `${skinboosterHref.de}/philart-auge`, en: `${skinboosterHref.en}#polynucleotides-philart` }, bookingUrls: Constants.appointmentUrlsByService.skinboosterPhilartEye, packageOffer: { quantity: 3, label: threeTreatmentBadge, badge: threeTreatmentBadge, price: { amount: 799, currency: "EUR" } } },
      { slug: "profhilo", label: { de: "Profhilo", en: "Profhilo" }, price: { currency: "EUR", displayOverride: byConsultation }, detailHref: { de: `${skinboosterHref.de}/profhilo`, en: `${skinboosterHref.en}#profhilo` }, bookingUrls: Constants.appointmentUrlsByService.skinboosterProfhilo },
    ],
  },
  hairTherapy: {
    slug: "haarausfall",
