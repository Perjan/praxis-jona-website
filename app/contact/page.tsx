    ...
    images: [
      {
        ...
        width: 1200,
        height: 600,
        alt: 'Realtime Screen Time Control app screenshot'
      }
    ],
  },
  alternates: {
      ...
      <div className="bg-white mt-2 sm:mt-10">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <h2 className="mt-2 text-lg leading-8 text-gray-600">Thank you for choosing Realtime Screen Time Control – we're excited to be a part of your wellbeing journey!</h2>
          </div>
          <div className="mt-20">
            <ContactSection />
          </div>
