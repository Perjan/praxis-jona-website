            ...
            <div className="overflow-hidden bg-white relative isolate">
                ...
                <div className="overflow-hidden">
                    <SectionWithColor backgroundClassName='bg-lightBeige'>
                        ...
                        <p className="mt-6 text-lg leading-8 text-primaryLighter">Die Symptome bei einer Überfunktion:</p>
                    ...
                    <SectionWithColor backgroundClassName='bg-tealColor'>
                        <p className="text-lg leading-8 text-primaryLighter">Die Symptome bei einer Unterfunktion:</p>
                        ...
                        <p className="text-lg mt-2 font-serif font-medium leading-8 text-primaryLighter">Blutuntersuchungen</p>
                        ...
                        <p className="text-lg mt-2 font-serif font-medium leading-8 text-primaryLighter">Ultraschalluntersuchung</p>
                        ...
                        <p className="text-lg mt-2 font-serif font-medium leading-8 text-primaryLighter">Schilddrüsenszintigraphie</p>
                        <p className="mt-2 text-lg leading-8 text-primaryLighter">Die Untersuchung wird nur bei verdächtigten Veränderungen im Ultraschall empfohlen.</p>
                    </SectionWithColor>
                </div>
            </div>
        </>
