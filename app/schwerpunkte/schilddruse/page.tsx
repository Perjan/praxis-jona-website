            ...
            <div className="overflow-hidden bg-white relative isolate">
                ...
                <div className="overflow-hidden">
                    <SectionWithColor backgroundClassName='bg-lightBeige'>
                        ...
                        <p className="mt-6 text-lg leading-8 font-semibold text-primaryLighter">Die Symptome bei einer Überfunktion:</p>
                        ...
                        <p className="text-lg mt-6 leading-8 font-semibold text-primaryLighter">Die Symptome bei einer Unterfunktion:</p>
