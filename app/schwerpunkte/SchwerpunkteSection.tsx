                        ...
                        <li key={schwerpunkte.name}>
                            ...
                            <p className="text-base leading-7 text-gray-600">
                                {schwerpunkte.descriptionRest.split('\n\n').map((text, i) => (
                                    <span key={i} style={{ display: i === 0 || expanded ? 'block' : 'none' }}>
                                        {text}
                                        <br />
                                    </span>
                                ))}
