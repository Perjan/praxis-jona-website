...
const description = "To calculate your debt payoff payments, start by making a list of all your debts, including the balance owed, interest rates, and minimum payments."
...
export const metadata: Metadata = {
    ...
    openGraph: {
      ...
      description: description,
      type: 'website',
      url: '/financial-calculators/debt-payoff-calculator',
      images: [
        {
    ...
    alternates: {
      canonical: '/financial-calculators/debt-payoff-calculator'
    },
    twitter: {
