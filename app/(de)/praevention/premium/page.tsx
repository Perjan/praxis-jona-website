...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: url,
        languages: {
            de: "/praevention/premium",
            en: "/en/prevention/premium",
            "x-default": "/praevention/premium",
        },
    }
}
                ...
                <SectionWithColor backgroundClassName='bg-lightBeige rounded-xl lg:rounded-2xl overflow-hidden'>
                    <div className="prose prose-lg max-w-none">
                        ...
                        <div className="mt-12 text-center">
                            <p className="text-base text-primaryLighter">Weitere Pakete vergleichen:</p>
                            <div className="mt-3 flex flex-wrap items-center justify-center gap-4">
                                <Link href="/praevention/basic" className="text-primary underline">BASIC Paket</Link>
                                <Link href="/praevention/medium" className="text-primary underline">MEDIUM Paket</Link>
                            </div>
                        </div>
                    </div>
                </SectionWithColor>
