...
export const Specialties = [
  ...
  export const SpecialtiesEN = [
    ...
    // },
    {
      ...
      descriptionRest: "\n\n A malfunction of the thyroid gland can cause a wide range of symptoms and significantly impairs well-being. The most common diseases are hypothyroidism (e.g. Hashimoto's), hyperthyroidism (e.g. Grave's disease) and thyroid nodules. Thyroid diagnostics are crucial for the early detection and treatment of such diseases.\n\n\n\n We offer:\n\n - Blood tests\n\n\n Checking the thyroid hormones in the blood to assess the function of the thyroid gland. \n\n - Ultrasound examination\n\n An imaging method to detect the size, structure and possible nodules or cysts in the thyroid gland.\n\n\n\n Early diagnosis and adequate treatment of thyroid diseases can significantly improve the quality of life.",
    ...
    {
      name: 'Lipid Metabolic Disorders',
      id: '3',
      description:
