...
export const anamneseCopy = {
  de: {
    ...
    title: "Anamnesebogen",
    intro: "Bitte füllen Sie diesen Bogen möglichst vollständig aus. Die Angaben helfen uns, Ihr Gesundheitsprofil ganzheitlich zu verstehen und Ihr Longevity-Programm individuell zu gestalten.",
    next: "Weiter",
    back: "Zurück",
    submit: "Absenden",
    ...
    api: {
      successMessage: "Anamnesebogen erfolgreich gesendet",
      mockMessage: "Anamnesebogen lokal validiert",
    },
  ...
  en: {
    ...
    api: {
      successMessage: "Medical history form sent successfully",
      mockMessage: "Medical history form locally validated",
    },
    ...
    pdf: {
      ...
      filenamePrefix: "Medical_History_Form",
    },
  },
} as const;
