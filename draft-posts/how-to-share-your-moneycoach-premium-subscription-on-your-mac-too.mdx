...
After your subscription becomes available on your Mac too, you can activate use iCloud to sync data across your Apple devices. Here's a guide on how to correctly do that - [tap here](https://moneycoach.ai/how-to-activate-cloud-sync/).
