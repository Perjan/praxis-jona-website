...
- **2026-09-10 — Observation hold, day 2:** collection completed, but Search Console detail rows still end September 7 and therefore contain no post-launch evidence. The rolling dashboard has 526 web clicks, 29,352 impressions and 1.79% search CTR; the iron-cost page has 82 clicks from 5,501 impressions (1.49% CTR, position 8.39), and `eiseninfusion kosten` has 14 clicks from 2,581 impressions (0.54% CTR, position 6.87). The aligned Umami window has 5,572 pageviews, 2,003 visitors, 107 booking CTA clicks and 81 unique converting visitors (1.92% per pageview; 4.04% per visitor); the iron-cost page has 353 pageviews, 254 visitors and 14 bookings (3.97% per pageview; 5.51% per visitor). The positive event counts confirm instrumentation remains active, but rolling rates still mix pre-instrumentation days and cannot be attributed to the snippet. Preserve the experiment until September 22 or 500 post-launch impressions.
- **2026-09-11 — First partial launch-day evidence:** Search Console detail rows now include September 8, the deployment date. That day the iron-cost page recorded six clicks from 269 impressions (2.23% CTR, position 8.09); `eiseninfusion kosten` recorded zero clicks from 95 impressions at position 6.69. Deployment timing means this is not a clean full-day treatment sample, and 269 page impressions remain below the 500-impression threshold. The rolling 28-day dashboard has 544 web clicks, 30,053 impressions and 1.81% search CTR; the iron-cost page has 88 clicks from 5,655 impressions (1.56% CTR, position 8.31). The aligned Umami window has 5,707 pageviews, 2,050 visitors, 147 booking CTA clicks and 105 unique converting visitors (2.58% per pageview; 5.12% per visitor); the iron-cost page has 376 pageviews, 273 visitors and 23 booking events from 20 unique visitors (6.12% per pageview; 7.33% per visitor). Tracking is active, but the rolling Umami window still mixes pre-instrumentation days and the snippet affects search presentation rather than on-page persuasion. Preserve the snippet and wait for at least 500 post-launch impressions or September 22.
...
| 2026-09-10 | Collect day-2 evidence and check CTA instrumentation health | Measured | [Production page](https://praxisjona.de/leistungen/eiseninfusion-kosten) | Search Console + aggregate Umami API | GSC detail still ends before launch; 107 booking CTA clicks confirm tracking is active. Hold until September 22 or 500 post-launch impressions |
| 2026-09-11 | Review first partial launch-day search evidence and CTA health | Measured | [Production page](https://praxisjona.de/leistungen/eiseninfusion-kosten) · [PR #11](https://github.com/Perjan/praxis-jona-website/pull/11) | Search Console + aggregate Umami API | September 8 page CTR was 2.23% from 269 impressions; below threshold and deployment-day timing is mixed. Hold until 500 post-launch impressions or September 22 |
