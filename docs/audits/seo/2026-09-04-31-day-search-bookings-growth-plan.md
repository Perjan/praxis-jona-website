...
| 6 | In progress (PR #9) | Rewrite/test title and meta description for `eiseninfusion kosten`; retain price and Berlin | SEO/Clinical | Snippet directly answers price, location and medical qualification |
...
| 2026-09-08 | Iron-cost snippet experiment + rendered FAQ-schema correction | In progress | [PR #9](https://github.com/Perjan/praxis-jona-website/pull/9) | User approved snippet; clinical body unchanged | Baseline: 80 clicks / 5,238 impressions / 1.53% page CTR; observation begins only after production deployment |
